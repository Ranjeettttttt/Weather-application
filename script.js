...
class WeatherApp {
    ...
    displayForecast(data) {
        ...
        // Group forecast by day and take one reading per day (at 12:00 PM)
    ...
    toggleTemperatureUnit() {
        ...
        // Update temperature display if weather data is already loaded
        if (this.currentWeatherSection.classList.contains('hidden')) return;
        
        // This would require storing the current weather data to convert
        // For simplicity, we'll reload the data for the current city
    ...
    checkForAlerts(weatherData) {
        ...
        if (temp > 40) {
            this.alertMessage.textContent = 'Extreme heat warning! Temperature is above 40°C. Stay hydrated and avoid prolonged sun exposure.';
            this.alertSection.classList.remove('hidden');
        } else if (temp < 0) {
            this.alertMessage.textContent = 'Freezing temperatures! Dress warmly and be cautious of icy conditions.';
            this.alertSection.classList.remove('hidden');
        }
    }
    ...
    changeBackground(weatherCondition) {
        ...
        this.appContainer.classList.remove(
            'sunny-bg', 'cloudy-bg', 'rainy-bg', 'snowy-bg', 'stormy-bg', 'night-bg'
        );
        ...
        if (condition.includes('clear')) {
            ...
            if (hour >= 6 && hour < 18) {
                this.appContainer.classList.add('sunny-bg');
            } else {
                this.appContainer.classList.add('night-bg');
            }
    ...
    showLoading() {
        // In a real implementation, you would show a loading spinner
